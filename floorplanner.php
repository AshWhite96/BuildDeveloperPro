...
<head>
	...
	<script src="js/FloorPlanner-WallBuildingTool.js"></script>
	<script src="js/FloorPlanner-WallReshapingTool.js"></script>
	<script src="js/FloorPlanner-Templates-General.js"></script>
	<script src="js/FloorPlanner-Templates-Furniture.js"></script>
	<script src="js/FloorPlanner-Templates-Walls.js"></script>
	<script src="js/Floorplan.js"></script>
	<script src="js/FloorplanPalette.js"></script>
	<script src="js/FloorplanFilesystem.js"></script>
	<script src="js/FloorplanUI.js"></script>
	<script src="js/Floorplanner-Constants.js"></script>

	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
	<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/jquery-ui.min.js"></script>

	<link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/themes/smoothness/jquery-ui.css" />
	<link rel="stylesheet" type="text/css" href="css/FloorPlanner.css" />
</head>
<body id="body" onload="init()">
	...
	<ul>
		...
		<li><a href="FloorplanPalette.js">FloorplanPalette.js</a>- A special kind of <a href="https://gojs.net/latest/api/symbols/Palette.html">Palette</a> linked with a specific instance of Floorplan</li>
